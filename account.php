...
<!--END:NAV-->
  ...
  <div class="subpagecontainer" style="padding:75px 30% 0 30%;">
    <!--side nav-->
    <div class="side-navigation">
      <ul class="list-unstyled">
        <li><a href="account.php" class="btn btn-info btn-lg active">Account</a></li>
        <li><a href="orders.php" class="btn btn-info btn-lg">Orders</a></li>
      <!--  <li><a href="moreinfo.php" class="btn btn-info btn-lg" display="none";>Info</a></li>-->
      </ul>
    </div><!--side navigation-->
    <div class="row" >
      <div class="small-12">
