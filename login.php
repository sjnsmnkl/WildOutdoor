...
<!--END:NAV-->
    ...
    <form method="POST" action="verify.php" style="padding:120px 15% 0 15%; height:calc(100% - 92px)">
      <div class="row">
        <div class="small-8">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="email" id="right-label" placeholder="xxx@email.com" name="username">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
